...
`VirtualPrivateServer`$`sudo apt-get update && sudo apt-get install git`
...
<input type="checkbox" class="sidebar-checkbox" id="sidebar-checkbox">
`VirtualPrivateServer`$`sudo apt-get update && sudo apt-get dist-upgrade && sudo apt-get autoremove`
